        ...
        <div id="myCarousel" className="carousel slide" data-ride="carousel">
            ...
            <div className="carousel-inner">
                <div className="carousel-item active">
                     <img className="first-slide" src={require('./../images/home/pexels-garvin-st-villier-3311574.jpg')} alt="First slide"/>
                ...
                <div className="carousel-item">
                    <img className="second-slide" src={require("./../images/home/pexels-photo-1075947.jpeg")} alt="Second slide"/>
                    <div className="container">
                ...
                <div className="carousel-item">
                    <img className="third-slide" src={require("./../images/home/pexels-photo-849835.jpeg")} alt="Third slide"/>
                    <div className="container">
